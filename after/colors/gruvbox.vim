" approximate g:gruvbox_improved_strings
highlight String ctermbg=237 guibg=#3c3836

" make line numbers blend into background
highlight LineNr ctermfg=239 guifg=#504945

" make current window's statusline stand out
highlight StatusLine guifg=#665c54

" make TODO keywords stand out more
highlight Todo ctermbg=24 guibg=#076678

" make spelling errors stand out more
