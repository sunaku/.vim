...
Shortcut! , (sneak) repeat last sneak backward
...
" autocmd VimEnter * call s:onload()
" function! s:onload() abort
"   " be different from Search highlight
"   highlight! link Sneak PmenuThumb
"   highlight! link SneakLabel IncSearch
"   highlight! link SneakLabelMask Visual
" endfunction
