...
" https://github.com/niflostancu/dotfiles-vim/blob/master/config/mappings.vim
autocmd TabLeave * let g:lasttab = tabpagenr()
Shortcut switch to most recently focused tab
      \ nnoremap <silent> <Leader>o :execute 'normal! '. g:lasttab .'gt'<CR>
